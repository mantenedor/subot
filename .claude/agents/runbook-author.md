...
<!-- gerado por bastiao/scripts/sync-claude-agents.py a partir de ia/agents/runbook-author.md; não edite diretamente. Origem multi-IA: provider=ollama model=qwen2.5:14b -->
