...
#
# DESTRUTIVO: sobrescreve ./data, ./domain, ./bastiao/.env (e ./bastiao/secrets, se
...
echo "Isto vai SOBRESCREVER ./data, ./bastiao/.env, ./domain (e ./bastiao/secrets, se presente no arquivo)."
