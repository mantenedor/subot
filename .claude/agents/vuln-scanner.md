...
<!-- gerado por bastiao/scripts/sync-claude-agents.py a partir de ia/agents/vuln-scanner.md; não edite diretamente. Origem multi-IA: provider=anthropic model=claude-sonnet-5 -->
