...
<!-- gerado por bastiao/scripts/sync-claude-agents.py a partir de ia/agents/stack-maintainer.md; não edite diretamente. Origem multi-IA: provider=ollama model=qwen2.5:7b -->
...
recorrentes, e prefira rodar `bastiao/scripts/healthcheck.sh` a reinventar verificações manuais.
